...
using FronkonGames.SpiceUp.Stoned; // Ensure this namespace is correct

public class Poison : MonoBehaviour
{
    public Stoned poisonEffect; // Assign this in the inspector with your Drunk component
    ...
    {
        if (poisonEffect != null && controlObject.activeInHierarchy)
        {
    ...
    IEnumerator AdjustIntensityOverTime(float startIntensity, float endIntensity, float time)
    {
        ...
        while (elapsedTime < time)
        {
            ...
            poisonEffect.settings.intensity = newIntensity; // Ensure your drunkEffect class has a public reference to settings
        ...
        poisonEffect.settings.intensity = endIntensity;
    }
}
