...
namespace FronkonGames.SpiceUp.Stoned
{
  ...
  {
    private static Stoned renderFeature;
      ...
      get
      {
        if (renderFeature == null)
        {
          ...
          if (pipelineAsset != null)
          {
            ...
            {
              if (scriptableRendererData.rendererFeatures[i] is Stoned)
                renderFeature = scriptableRendererData.rendererFeatures[i] as Stoned;
            }
          }
        }
